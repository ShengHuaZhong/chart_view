...
// configuration step. It creates a namespace called `chart_view`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", chart_view::cmake::project_name, chart_view::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", chart_view::cmake::project_version);
      return EXIT_SUCCESS;
    }
